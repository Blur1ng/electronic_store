...
<head>
    ...
    <title>Каталог товаров - Electronics Store</title>
        ...
        <div class="container">
            ...
            <div class="filters">
                ...
                <div class="filter-group">
                    ...
                    <div class="form-group">
                        <label for="minPriceFilter">Цена от:</label>
                        <input type="number" id="minPriceFilter" placeholder="0">
                    </div>
                    <div class="form-group">
                        <label for="maxPriceFilter">Цена до:</label>
                        <input type="number" id="maxPriceFilter" placeholder="1000000">
                    </div>
                </div>
            ...
            <div id="loadingIndicator" class="loading" style="display: none; text-align: center; margin: 2rem 0;"></div>
        </div>
    </main>
